...
- your guild's name;
- your guild's description (if any);
- your guild's icon;
- unique Discord User ID of the guild's owner;
- username of the guild's owner;
- approximate member count of the guild.

As stated, this information is only used for security purposes and is not shared with any third party. This information
is never stored on Coined's backend servers.
...
Coined is an open-source bot; if you have any privacy or security concerns regarding Coined,
you can view the source code [by clicking here](https://github.com/jay3332/DankRipoffRemastered).